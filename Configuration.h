...
#define STRING_CONFIG_H_AUTHOR "(Multi3D, Standalone config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10 Standalone"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "51deacfe-5eff-4f18-befa-f0f08223baff"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 33.50
  #define DEFAULT_Ki 4.13
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 37.03
  #define DEFAULT_bedKi 6.46
  #define DEFAULT_bedKd 141.58
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400.20, 409.78 }
 ...
 *
 */
#define Z_MIN_PROBE_PIN 19 // Pin 32 is the RAMPS default gewechselt zu pin 19 z-max
